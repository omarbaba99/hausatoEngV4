...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("three", "biyu", R.drawable.number_three,R.raw.three));
        ...
        words.add(new Word("seven", "bakwai", R.drawable.number_seven,R.raw.seven));
        ...
        words.add(new Word("ten", "goma", R.drawable.number_ten,R.raw.ten));
